    ...
    <div class="card card-register mx-auto mt-5">
      ...
      <div class="card-body">
        <form>
          ...
          <div class="form-group">
            <div class="form-row">
              ...
              <div class="col-md-6">
                <div class="form-label-group">
                  <input type="gender" id="gener" class="form-control" placeholder="Gender " required="required">
        ...
        <div class="text-center">
          <a class="d-block small mt-3" href="ibjt_index.php">Go Back To Main Page</a>
        </div>
      </div>
    </div>
  </div>
